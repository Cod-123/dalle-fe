  ...
  return (
    <div>
      <div className='flex items-center gap-2 mb-2'>
        ...
        {isSurpriseMe && (
          <button type='button' onClick={handleSurpriseMe} className='font-semibold border text-xs bg-[#ECECF1] py-1 px-2 rounded-[5px] text-yellow'>
            Surprise Me
          </button>
        )}

        {/* text inputs for entering the values */}
